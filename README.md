...
### Recommendations
* The click_time can potentially helps the ML algorithm to seperate between fraud clicks from those that are not. The same procidure can be done, taking the click_time into account.
